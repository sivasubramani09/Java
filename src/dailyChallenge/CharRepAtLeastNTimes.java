...
/*	Characters Repeating Atleast N times
	...
	The program must accept a string S and an integer N as input. The program must print the count of characters repeating consecutively atleast N times as the output.
...
public class CharRepAtLeastNTimes {
	public static void main(String[] args) {
		String in ="abcdbcd";//"aaaabbcccbb";//"aabccbhhhh";
		int n = 1;//3;//2;
